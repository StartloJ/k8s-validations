...
RUN echo "dca623b36aef84fbdf28f79d02e9b3705ff641424ac1f872d5420dadb12fb78d  /tmp/kustomize_${kustomize_version}_linux_amd64.tar.gz" | sha256sum -c
RUN tar -xvzf /tmp/kustomize_${kustomize_version}_linux_amd64.tar.gz -C /usr/local/bin
